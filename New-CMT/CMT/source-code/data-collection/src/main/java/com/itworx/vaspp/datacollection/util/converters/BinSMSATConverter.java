...
public class BinSMSATConverter extends AbstractTextConverter{
	private Logger logger;
public BinSMSATConverter()
{}
...
throws ApplicationException, InputException {
	...
	logger
			.debug("Inside BinSMSATConverter convert - started converting input files");
	String path = PropertyReader.getConvertedFilesPath();
	File[] outputFiles = new File[1];
	File outputFile = new File(path, "SMSAT"+inputFiles[0].getName());
	           ...
	           String line;
	            ...
	            while(inputStream.ready())
	            {
	            	...
	            	else if (line.contains("MoAt"))
	            	{
	            		line = inputStream.readLine();
	            		appName="";
	            		while(line!=null&&!line.contains(" applicationName =")&&(!line.contains("File:")))
	            		{
	            		...
	            		{
	            			appName= line.split(" applicationName =")[1];
	...
	catch(IllegalThreadStateException  e)
   {
	   e.printStackTrace();
		...
		logger
				.error("BinSMSATConverter.convert() - Input file not found "
						+ e);
	...
	logger
			.debug("BinSMSATConverter.convert() - finished converting input files successfully ");
	return outputFiles;
}
public static void  main(String ag[])
{
	 ...
	 try {
    		...
    		BinSMSATConverter s = new BinSMSATConverter();
