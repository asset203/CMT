...
public class CCNPlatformMeasuresData extends PersistenceObject{
    ...
    public double getMaxAvgCpuLoad() {
        return maxAvgCpuLoad;
    }
    public void setMaxAvgCpuLoad(double maxAvgCpuLoad) {
        this.maxAvgCpuLoad = maxAvgCpuLoad;
    }
