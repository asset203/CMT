...
* This also means that rearranging the SQL statement or adding a parameter doesn't involve renumbering your indices.
* Code such as this:
...
public class NamedParameterStatement {
	...
	public static final char PARAM_INDICATOR = ':';
		...
		for (int i = 0; i < length; i++) {
			...
			if (inSingleQuote) {
				...
				if (c == '\'') {
					...
					inDoubleQuote = true;
				} else if (c == PARAM_INDICATOR && i + 1 < length
	 ...
	 * @throws IllegalArgumentException
	 *             if the parameter does not exist
	 * @see PreparedStatement#setDate(int, java.sql.Timestamp)
	 */
	...
	public boolean hasParameter(String parameter){
		int[] indexes = getIndexes(parameter);
