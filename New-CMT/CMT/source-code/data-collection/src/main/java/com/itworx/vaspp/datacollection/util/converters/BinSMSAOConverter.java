...
public class BinSMSAOConverter extends AbstractTextConverter{
	private Logger logger;
public BinSMSAOConverter()
{}
...
throws ApplicationException, InputException {
	...
	logger
			.debug("Inside BinSMSAOConverter convert - started converting input files");
	...
	catch(IllegalThreadStateException  e)
   {
	   e.printStackTrace();
		...
		logger
				.error("BinSMSAOConverter.convert() - Input file not found "
						+ e);
	...
	logger
			.debug("BinSMSAOConverter.convert() - finished converting input files successfully ");
	return outputFiles;
}
public static void  main(String ag[])
{
	 ...
	 try {
    		...
    		BinSMSAOConverter s = new BinSMSAOConverter();
