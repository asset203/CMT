/* 
 * File:       HLR_Relay_Signal.java
 * Date        Author          Changes
 * 13/02/2006  Nayera Mohamed  Created
 * 
 * Persistence class for HLR Relays Signals Data
 */
package com.itworx.vaspp.datacollection.persistenceobjects;

import java.util.Date;

public class HLR_Relay_Signal extends PersistenceObject {
