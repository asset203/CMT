...
import java.util.*;
public class SMSLgpDetailedData extends PersistenceObject {
...
public Date getDateTime() {
	...
	public String getTermMSISDN() {
		return termMSISDN;
	}
	public void setTermMSISDN(String termMSISDN) {
		this.termMSISDN = termMSISDN;
	}
