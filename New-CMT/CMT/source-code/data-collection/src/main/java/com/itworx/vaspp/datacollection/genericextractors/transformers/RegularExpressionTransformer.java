...
public class RegularExpressionTransformer extends InputFilesTransformer{

    public void trasformFiles(File[] inputFiles ,GenericInputStructure inputStructure,Logger logger) throws ApplicationException {
    	logger
		.debug("RegularExpressionTransformer.trasformFiles() - started transforming input files ");
